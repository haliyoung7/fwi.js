...
var flashCard = new _index.Region('FlashCard', 'Main', [710, 390], [500, 300]);

var sleep = function sleep(ms, callback) {
    window.setTimeout(callback, ms);
};

var animateFlashCardOut = function animateFlashCardOut() {
    flashCard.resize([0, 300], 2000, 'easeOutBounce');
};

var animateFlashCardIn = function animateFlashCardIn() {
    flashCard.resize([500, 300], 2000, 'easeOutBounce');
};

var fadeTextIn = function fadeTextIn() {
    _index.Template.PlayContent('Text', 'FlashCard');
};

var fadeTextOut = function fadeTextOut() {
    _index.Template.PlayContent('Blank', 'FlashCard');
};
...
var _template = require('./src/template.js');

var _region = require('./src/region.js');

var _content = require('./src/content.js');
},{"./src/content.js":3,"./src/player.js":6,"./src/region.js":7,"./src/template.js":8}],3:[function(require,module,exports){
'use strict';
...
},{"./fwi_core":5}],4:[function(require,module,exports){
"use strict";
...
},{"./fwi_core":5}],7:[function(require,module,exports){
'use strict';
...
},{"./easing_types":4,"./template":8}],8:[function(require,module,exports){
'use strict';
