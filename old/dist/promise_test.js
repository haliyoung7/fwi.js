...
var windowNames = (typeof window === 'undefined' ? 'undefined' : _typeof$2(window)) == 'object' && window && Object.getOwnPropertyNames ? Object.getOwnPropertyNames(window) : [];
...
var toMetaKey$1 = function toMetaKey(it) {
  return it === undefined || (typeof it === 'undefined' ? 'undefined' : _typeof$3(it)) == 'symbol' ? it : String(it);
};
...
var flashCard = new Region('FlashCard', 'Main', [710, 390], [500, 300]);

flashCard.resize([0, 300], 2000, 'easeOutBounce').then(function () {
    return flashCard.resize([500, 300], 2000, 'easeOutBounce');
}).then(function () {
    return flashCard.resize([0, 300], 2000, 'easeOutBounce');
}).then(function () {
